...
STOP_WORDS = {"poc", "exploit", "scanner", "detector", "finder", "tool", "tools", "awesome", "list", "cve", "rce", "shell", "vulnerability", "vulnerable", "checker"}
BAD_ALIAS_TERMS = {"app", "words", "proof", "concept", "ioc", "iocs", "scanner", "detector", "finder", "environment", "variables", "bypass", "vuln", "scan", "local", "secrets", "check", "checker"}
